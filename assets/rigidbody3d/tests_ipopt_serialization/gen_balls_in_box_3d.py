...
"""
    ...
    result = \
        f"""
        <rigidbody3d_scene>
  <camera_perspective theta="1.0472" phi="0.785398" rho="{s*1.4}" lookat="0 0 0" up="0 1 0" fps="50" render_at_fps="0" locked="0"/>
  ...
  <impact_operator type="grr" CoR="1.0">
    ...
    os.makedirs('balls_in_box_3d', exist_ok=True)
    with open(os.path.join('balls_in_box_3d', f'{size}.xml'), 'w') as f:
        f.write(result)
